...
public class EncEficiente{
	...
	ArrayList<LinhaEncomenda> linhaEncomenda;
	String nome;
	String nif;
	String morada;
	int nrEncomenda;
	...
	public EncEficiente(){
		...
		this.morada = "";
		this.nrEncomenda = 0;
		this.data = LocalDate.parse("2000-01-01");
	}
	
    /**
     * Construtor parametrizado de EncEficiente.
     */	
	public EncEficiente(ArrayList<LinhaEncomenda> linhaEncomenda, String nome, String nif, String morada, int nrEncomenda, LocalDate data){
		this.linhaEncomenda = new ArrayList<LinhaEncomenda>(linhaEncomenda);
		this.nome = nome;
		this.nif = nif;
		this.morada = morada;
	...
	public EncEficiente(EncEficiente o){
		this.linhaEncomenda = o.getLinhaEncomenda();
		this.nome = o.getNome();
		this.nif = o.getNif();
		this.morada = o.getMorada();
		this.nrEncomenda = o.getNrEncomenda();
		this.data = o.getData();
	}
     ...
     */
	public void setNrEncomenda(int nr){
		this.nrEncomenda = nr;
	}
	...
	public boolean equals(Object obj){
		...
		return this.linhaEncomenda.equals(e.getLinhaEncomenda()) &&
